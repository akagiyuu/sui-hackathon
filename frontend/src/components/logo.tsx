...
export function Logo() {
    return (
        <div className="flex items-center space-x-3 group">
            <div className="bg-red-500 w-8 h-8 rounded-lg flex items-center justify-center group-hover:bg-neutral-100 transition-all duration-300 group-hover:scale-110 group-hover:rotate-3">
